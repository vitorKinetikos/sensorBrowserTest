document.addEventListener("DOMContentLoaded", () => {
  ...
  // Start wake lock by playing the hidden video
  function startWakeLock() {
    // Attempt to play the video. This may require user interaction.
    wakeLockVideo.play().catch((error) => {
      console.warn("Could not start wake lock video:", error);
    });
  }

  // Stop wake lock by pausing the video
